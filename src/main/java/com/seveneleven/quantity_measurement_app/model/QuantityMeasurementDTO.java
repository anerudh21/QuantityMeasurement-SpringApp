...
@Schema(description = "Data Transfer Object for Quantity Measurement operations")
public class QuantityMeasurementDTO {
    ...
    public static QuantityMeasurementDTO from(QuantityMeasurementEntity entity) {
        ...
        // Handle potential null result values from Entity
    ...
    public void setThatMeasurementType(String type) { this.thatMeasurementType = type; }
